...
# END of contributor methods
  ...
  def get_reviews
    # Always get assessments for a team
  ...
  def get_wiki_submissions
    ...
    # Check if the team count is greater than one(team assignment)
  ...
  def set_student_directory_num
    if self.directory_num.nil? or self.directory_num < 0           
      ...
      # Get participants irrespective of the number of participants in the team
      #removed check to see if it is a team assignment
      self.team.get_participants.each{
          | member |
